...
const Collection = () => {
  const { products, totalPages, fetchProducts, isLoading, error } =
  ...
  }, [fetchProducts, currentPage, debounceValue, category, subCategory, sortType]);
      ...
      <div className="flex flex-col gap-1 pt-10 border-t sm:flex-row sm:gap-10">
        ...
        <div className="flex-1">
          ...
          <div className="flex justify-center mt-8">
            <button disabled={currentPage === 1 ? true : false} onClick={prePage} className="px-4 py-2 mr-2 bg-gray-200 rounded disabled:opacity-50">
              Previous
            </button>
            <span className="px-4 py-2">Page {currentPage} of {totalPages}</span>
            <button disabled={currentPage === totalPages ? true : false} onClick={nextPage} className="px-4 py-2 ml-2 bg-gray-200 rounded disabled:opacity-50">
              Next
            </button>
          </div>
        </div>
